...
export const SpeechLenghtWidget = ({
  ...
  useEffect(() => {
    // Если есть realTimeData, используем их
  ...
  useEffect(() => {
    ...
    const option = {
      ...
      dataset: [
        {
          ...
          source: prepareSpeechDurationData(data),
        },
        {
          transform: {
            type: "sort",
            config: { dimension: "duration", order: "desc" },
          },
        },
      ],
      xAxis: {
      ...
      series: {
        ...
        itemStyle: { color: "#1776E0", borderRadius: [4, 4, 0, 0] },
      },
    };
